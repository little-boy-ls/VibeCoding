...
const tickOffCaptures: CaptureSlide[] = [
  mkTool(
    ...
    '倒计时首页',
    '黑夜 · 发工资 · 狐狸 mascot',
    '首页「下钟」黑夜模式：顶部 Tab 切换上班 / 上课 / 发工资，右侧日月切换昼夜天空。狐狸 mascot 探出卡片，大号倒计时 225:17:36，心情文案与目标发薪日行。四宫格 3D 快捷入口（专注 / 白噪音 / 小组件 / 设置）直接贴卡片、无底色块，底部「生成打卡海报」主按钮。',
    ['三模式 Segmented 切换', '昼夜天空主题', '3D 图标 + 狐狸 mascot'],
  ),
  mkTool(
    6,
    '倒计时首页',
    '白天 · 发工资 · 浅色天空',
    '同一首页白天模式：浅色天空背景，Segment 选中发工资，倒计时 225:15:55，目标发薪日每月 15 号。四宫格 3D 图标无容器底色，底部悬浮圆角 Tab 与「生成打卡海报」，与黑夜模式共用同一套布局。',
    ['白天 / 黑夜双主题', '3D 图标无底色', '发工资倒计时'],
  ),
  mkTool(
    2,
    '海报弹层',
    '保存分享 · 风景背景 · 完整预览',
    '从首页一键生成打卡海报：半屏弹层完整预览海报，城市日落风景背景 + 浮动信息卡，展示倒计时、发薪日、#打工人自嘲 标签与狐狸 mascot，底部「保存到手机 / 分享好友」，支持长按图片保存。',
    ['完整海报预览', '倒计时 + 心情文案', '保存 / 分享双 CTA'],
  ),
  mkTool(
    3,
    '打卡海报',
    '样式配置 · 背景图 · 实时预览',
    '海报 Tab：居中标题「打卡海报」，上方 TickPosterCanvas 实时预览（发工资 / 风景背景 / 城市日落），下方配置倒计时类型、海报样式（简约白卡 / 风景背景）、四张背景缩略图与吐槽文案输入，一键生成可分享图。',
    ['类型 / 样式 Segmented', '背景图四选一', '文案 + 实时预览'],
  ),
  mkTool(
    4,
    '打卡日记',
    'GitHub 热力图 · 连续 2 天 · 时间线',
    '日记 Tab：2026 年 GitHub 风格打卡热力图，连续打卡 2 天与超越 64% 用户统计。下方 2026 年 7 月时间线，卡片含发薪 Tag、文案「撑过这周，钱包就能喘口气了」与城市配图，形成年度打卡记录。',
    ['年度热力图', '连续打卡 + 超越比例', '按月时间线 + 配图'],
  ),
  mkTool(
    5,
    '设置',
    '目标时间 · 昼夜 · 提醒 · 背景',
    '设置 Tab：目标时间区配置上班 09:00、上课 08:30、发薪日每月 15 号（3D 图标行）；外观区切换首页天空（跟随时间）与默认海报背景四选一；提醒区上班 / 上课前 10 分钟推送开关，以及数据导出与清除缓存。',
...
export const portfolioWorks: PortfolioWork[] = [
  ...
  },
  {
    ...
    summary:
      '面向打工人的轻量倒计时工具：UniApp 单端 6 屏实机截图。覆盖首页昼夜双主题与三种倒计时（上班 / 上课 / 发工资）、3D 图标无底色快捷入口、打卡海报生成与分享、GitHub 风格打卡日记，以及目标时间与提醒设置。',
    clients: [
